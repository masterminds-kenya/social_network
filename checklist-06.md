# Feature Development Plan for June 2020 - ver 0.5.2
...
|                    | Creating batches for daily Cron of Posts        |
|                    | Capture Service/servers only run when needed    |
...
- [ ] ? Decide: does a Campaign need a start date field?
...
- [x] Process Capture service response, associating captured media urls to the related Post.
